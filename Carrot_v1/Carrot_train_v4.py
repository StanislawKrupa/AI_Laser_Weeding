...
# Train the model
model = object_detector.create(train_data, model_spec=spec, batch_size=8, train_whole_model=True, epochs=500, validation_data=val_data)
...
# Export the model
model.export(export_dir='.', tflite_filename='Carrot_v4.tflite')

# Evaluate the tflite model
tflite_eval_result = model.evaluate_tflite('Carrot_v4.tflite', val_data)
