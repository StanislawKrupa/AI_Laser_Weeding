...
for image_path in images:
    ...
    image_resized = cv2.resize(image_rgb, (448, 448))  
    resized = cv2.resize(image_rgb, dim, interpolation=cv2.INTER_AREA) #tutaj moja modyfikacja
    ...
    if show_results:
        cv2.imshow('Object detector', resized) ##MOJA MODYFIKACJA NA IMAGE_RESIZED
